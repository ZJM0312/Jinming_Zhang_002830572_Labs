...
public class ManageSuppliers extends javax.swing.JPanel {
    ...
    public ManageSuppliers(JPanel upc) {
        initComponents();
    ...
    public void refreshTable() {
        ...
        for(Supplier s : MainJFrame.SUPPLiER_DIRECTORY.getSupplierList()) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        //int i=1;
        AddSupplier as = new AddSupplier(userProcessContainer);
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        Supplier s = (Supplier)tblSuppliers.getValueAt(row, 0);
        MainJFrame.SUPPLiER_DIRECTORY.removeSupplier(s);
        refreshTable();
