...
public class AddSupplier extends javax.swing.JPanel {
    ...
    public AddSupplier(JPanel workArea) {
        initComponents();
    ...
    private void btnAddSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSupplierActionPerformed
        ...
        if(!txtName.getText().isEmpty()){
            Supplier supplier = MainJFrame.SUPPLiER_DIRECTORY.addSupplier();
            ...
            JOptionPane.showMessageDialog(this, "Supplier cannot be empty", "Warning", JOptionPane.WARNING_MESSAGE);
        }
